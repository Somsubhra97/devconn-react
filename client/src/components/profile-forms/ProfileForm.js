...
const ProfileForm = ({
 ...
 //     githubusername : profile.github ? profile.githubusername : '',
 ...
 //     linkedin: profile.social.limkedIn ? profile.social.linkedin : ''
 //   })
 //   };
 // }, [loading]);
...
export default connect(mapStateToProps,
  { createProfile, getCurrentProfile })(withRouter(
  ProfileForm
));
